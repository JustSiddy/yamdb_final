...
from api.permissions import (IsAdmimOrModeratorOrReadOnly, IsAdmimOrReadOnly,
                             IsAdminOrSuperUser)
...
class CategorieViewSet(mixins.CreateModelMixin,
...
class SignupViewSet(mixins.CreateModelMixin,
    ...
    def create(self, request, *args, **kwargs):
        ...
        User.objects.filter(
            username=username).update(confirmation_code=confirmation_code)
        send_mail(
